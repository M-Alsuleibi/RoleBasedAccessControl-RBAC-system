...
var User = function () {
    ...
    (function () {
        ...
        _username_decorators = [(0, typeorm_1.Column)({ nullable: false, length: 255 })];
        _hashPassword_decorators = [(0, typeorm_1.BeforeInsert)()];
        _password_decorators = [(0, typeorm_1.Column)({ nullable: false })];
        _email_decorators = [(0, typeorm_1.Column)({ nullable: false })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)({
                type: "timestamp",
                default: function () { return "CURRENT_TIMESTAMP()"; },
            })];
        _roles_decorators = [(0, typeorm_1.ManyToMany)(function () { return Role_js_1.Role; }, function (role) { return role.users; }, { cascade: ['soft-remove'], eager: true })];
        _profile_decorators = [(0, typeorm_1.OneToOne)(function () { return Profile_js_1.Profile; }, { eager: true }), (0, typeorm_1.JoinColumn)()];
