...
var isEmail_js_1 = require("validator/lib/isEmail.js");
...
var validateUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var values, user, errorList, test;
        ...
        switch (_a.label) {
            case 0:
                ...
                values.forEach(function (key) {
                    if (!user[key]) {
                        return errorList.push("".concat(key, " is Required to create User!"));
                    }
                });
                if (!isEmail_js_1.default.default(user.email)) {
                    errorList.push("Email is not Valid");
                }
                if (user.password.length < 6) {
                    errorList.push("Password should contain at least 6 characters!");
                }
                return [4 /*yield*/, User_js_1.User.findOneBy({
                        username: req.body.userName,
                    })];
            case 1:
                test = _a.sent();
                if (test) {
                    return [2 /*return*/, res.status(500).send("This username is already taken!")];
                }
                if (errorList.length) {
